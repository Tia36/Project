...
<html>
    ...
    body{
        background-image: url('images/icon/L.jpg');
...
<div class="row"><h4><?php echo $msg?></h4></div>
            <div class="row">
                 <div class="col-md-4 login-form-1">
                    <h3 style="color:blue;">Super Admin Login</h3>
                    <form action="slogin_server_page.php" method="get">
                ...
                <div class="col-md-4 login-form-1">
                    <h3 style="color:blue;">Student Login</h3>
