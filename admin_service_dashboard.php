...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="row"><h2 style="margin-left:35%;color: green;">Electronic Lab Device Transaction Platform</h2></div>
             <br>
            <div class="leftinnerdiv">
               ...
               <!-- <Button class="greenbtn" onclick="openpart('sendmail')"> <img class="icons" src="images/icon/checklist.png" width="30px" height="30px"/> Send Mail</Button>-->
            ...
            padding: 8px;'>Person Name</th><th>Person Type</th><th>Device name</th><th>Device Category</th><th>Days </th><th>Approve</th></tr>";
...
?>
           ...
           ?>
            ...
            <Button class="greenbtn" >ISSUE DEIVCE RECORD</Button>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style='  
            padding: 8px;'>Student Name</th><th>Device Name</th><th>Issue Date</th><th>Return Date</th></th><th>Person Type</th></tr>";
